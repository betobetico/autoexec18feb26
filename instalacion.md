...
Descarga el curso desde la URL que te dará tu instructor y guárdalo en una carpeta local:
...
### Leer ficheros nativamente

Si quieres un programa ligero y open source para leer ficheros de forma nativa, tanto en Mac como en Windows, puedes usar **Scratch**:

👉 [https://www.ericli.io/scratch](https://www.ericli.io/scratch)
